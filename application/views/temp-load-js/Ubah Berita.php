...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('input[name="id"]').val('<?php echo $data['id']?>');
        $('input[name="title"]').val('<?php echo $data['title']?>');
        $('select[name="category"]').val('<?php echo $data['category']?>');
        $('.textarea_editor').summernote('editor.pasteHTML', '<?php echo addslashes($data['content'])?>');
    });
